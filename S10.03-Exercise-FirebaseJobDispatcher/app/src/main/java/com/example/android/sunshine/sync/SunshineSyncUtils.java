...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int flextime_seconds = seconds/3;

    private static boolean sInitialized;

//  TODO (11) Add a sync tag to identify our sync job
    private static final String syncTag = "Sunshine sync";

//  TODO (12) Create a method to schedule our periodic weather sync
    static void firebaseScheduleDispatcherSync(final Context context){
        ...
        Job SunshineSyncJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(seconds, seconds+flextime_seconds))
